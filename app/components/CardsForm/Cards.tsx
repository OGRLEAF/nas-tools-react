...
import { CardProps, useCardsFormContext, ListItemCard } from ".";
...
const SelectionContext = createContext<CardsSelectionContext<any>>({ key: '' });

export const useSelectionContext = <Res extends ResourceType>() => useContext<CardsSelectionContext<Res>>(SelectionContext);
